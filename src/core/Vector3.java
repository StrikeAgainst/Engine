...
public class Vector3 extends Scalar3{
	...
	public static float colinear_scale(Vector3 v1, Vector3 v2) {
		float scale;
	...
	public float getBlockMagnitude() {
	...
	public float getEuclideanMagnitude() {
    ...
    public Vector3 getNormalized() {
        float scale = 1/ getEuclideanMagnitude();
